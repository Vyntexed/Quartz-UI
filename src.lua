...
local ElementCreator = {
	Title = function(self,Text)
		...
		a.Size = misc.table_to_UDIM2({0.9, 0},{0.08, 0})
	...
	Heading = function(self, Text)
		...
		a.TextScaled = true
		a.Parent = library._internal.new_parent
		a.Size = misc.table_to_UDIM2({0.9, 0},{0.072, 0})
		a.TextXAlignment = Enum.TextXAlignment.Left
		a.Parent = library._internal.latestContainer

		a.FontFace = NewFont(Enum.FontWeight.SemiBold,Enum.FontStyle.Normal)
	...
	Subheading = function(self, Text)
		local a = misc.Label(Text)
		a.BackgroundTransparency = 1
		a.TextScaled = true
		a.Parent = library._internal.new_parent
		a.Size = misc.table_to_UDIM2({0.9, 0},{0.068, 0})
		a.TextXAlignment = Enum.TextXAlignment.Left
		a.Parent = library._internal.latestContainer
	...
	Paragraph = function(self, Text)
		local a = misc.Label(Text)
		a.BackgroundTransparency = 1
		a.TextScaled = true
		a.Parent = library._internal.new_parent
		a.Size = misc.table_to_UDIM2({0.9, 0},{0.06, 0})
		a.TextXAlignment = Enum.TextXAlignment.Left
		a.Parent = library._internal.latestContainer
